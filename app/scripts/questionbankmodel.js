...
QuestionBankModel.prototype.chooseQuestion = function() {
	...
	var n5=base.randNumb5;
	
	var bob=base.randName1;
	var sally=base.randName2;
	var phil=base.randName3;
	var Sam=base.randName4;
	...
	this.question ="class Foo ~ ^ attr_accessor: "+ bob +" ~ ^  attr_reader: "+sally+" ~~ ^ @@"+phil+" = "+n1+" ~~^^"+Sam+" = "+n2+"~~^def initialize~^^@"+bob+" = "+n3+"~^^@"+sally+" = "+n4+"~^end ~~^def m1 (_b = "+n5+") ~^^@"+bob+" = @"+bob+" + _b ~^end ~~^  def self.m2(_p) ~^^ @@"+phil+" = @@"+phil+" + _p ~^end ~end ~~ x = Foo.new ~";
